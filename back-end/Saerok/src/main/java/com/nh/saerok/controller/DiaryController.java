...
//	}
	...
	// 다이어리 작성
	@PostMapping(value="/diary")
	public int insert(@RequestBody Diary d, MultipartFile multipartFile) throws FileNotFoundException {
		System.out.println("insert");
		System.out.println(d.getContent());
		System.out.println(d.getBaby_no());
		...
		if (multipartFile == null) {
			...
			System.out.println("d" + diary_no);
			return 1;
		}
		else {
			Photo photo = new Photo();
			photo = fileUpload(multipartFile);
			int n = service.insert(d);
			System.out.println("n" + n);
			String diary_no = service.maxId();
			System.out.println("d" + diary_no);
